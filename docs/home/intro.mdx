...
Guides in [**🇬🇧 English**](/home/english/prompt) use `lyra-en` to showcase various use cases of Muse, while `lyra-fr` is the star of the show in the [**🇫🇷 French**](/home/french/prompt) guides.
