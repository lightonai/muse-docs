...
In this short guide, learn how to use this skill with `orion-fr`. We assume here that the reader is familiar with the use of Create, as well as with the Python Bindings: for more information, check out the ✍️ [Create](/api/endpoints/create), and [Python Bindings](/api/bindings/python) documentation pages.
