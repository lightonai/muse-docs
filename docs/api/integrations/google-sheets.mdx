...
To complete cells in a sheet, select an area conaining parameters as the first row and then prompts.

Example:

| Prompt              | `n_tokens` | Completion             |
| ------------------- | ---------- | ---------------------- |
| TODO: Find a prompt |            | TODO: write completion |
| TODO                |            | TODO                   |
