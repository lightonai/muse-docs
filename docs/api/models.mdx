...
**Muse offers access to models with different capabilities in different languages to best fit your needs.**
Increasingly powerful models are slower and more expensive, but they can tackle more tasks more effectively.

You can select which model to use by setting the **`X-Model`** header in your API call. Models codenames are formatted as
