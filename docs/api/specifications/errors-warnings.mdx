...
-   Codes in the **400** range indicate something was wrong with your request. This will usually be detailed: it may be mistyped a parameter, provided an incorrect value, etc.
